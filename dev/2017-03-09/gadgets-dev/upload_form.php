 ...
 */
$thumbWidth = 50; //in pixels - change if not big enough
 ...
 */
$imagePrefix = "customer"; //change customer to destination to work with vacation spots list

/**
 * image extension - currently only supporting .jpg - see upload_execute.php
 */
$extension = ".jpg"; //change .jpg to .jpeg to work with the vacation spots list
