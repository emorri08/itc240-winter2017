...
*/
define('VIRTUAL_PATH', 'http://example.com/gadgets/'); 

define('PHYSICAL_PATH', '/home/username/example.com/gadgets/'); # Physical (PHP) 'root' of application for file & upload reference
...
/*
INCLUDE MyAutoLoader.php file only if you've 
completed the Pager assignment.
...
/*
START PLACEMENT OF YOUR VERSIONS OF switch AND $nav1!--------------
